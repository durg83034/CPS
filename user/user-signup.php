...
<input type="email" class="form-control form-control-lg no-b" name="email" id="email" placeholder="Enter your email" required="true">
              ...
              <input type="radio" name="gender" id="gender" value="Male"><strong style="color: white">Male</strong>
                            ...
                            <div class="col-lg-12"> <button class="btn0">
                                <input type="submit" class="btn btn-success btn-lg btn-block" name="submit" value="Sign Up"> </button>
                                <button class="btn1"> <p class="forget-pass text-white">
    <a href="login.php"> Already Have an Account ? </a></p> </button>
                                <button class="btn2"><p class="forget-pass text-white"><a href="../index.php"> Back to Home!!</a></p></button>
                            </div>
                        </div>
                    </form>
                </div>
